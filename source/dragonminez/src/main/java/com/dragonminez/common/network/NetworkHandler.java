...
public class NetworkHandler {
	...
	public static void register() {
		SimpleChannel net = NetworkRegistry.ChannelBuilder
				...
				.networkProtocolVersion(() -> "manorsz-party-arena-1")
				.clientAcceptedVersions("manorsz-party-arena-1"::equals)
				.serverAcceptedVersions("manorsz-party-arena-1"::equals)
				.simpleChannel();

		INSTANCE = net;
        net.messageBuilder(PartyHudS2C.class, id(), NetworkDirection.PLAY_TO_CLIENT).decoder(PartyHudS2C::new).encoder(PartyHudS2C::encode).consumerMainThread(PartyHudS2C::handle).add();
